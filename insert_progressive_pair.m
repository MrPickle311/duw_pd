function [result] = insert_progressive_pair(jacobi_matrix,body_i,body_j,row,ri,fi_i,si,rj,fi_j,vec)
    % niestety matlab przekazuje tylko przez wartosc, pass by value
    first_row = 2*row - 1;
    second_row = 2*row;
    temp = jacobi_element_for_progressive_pair(ri,fi_i,si,rj,fi_j,vec);
